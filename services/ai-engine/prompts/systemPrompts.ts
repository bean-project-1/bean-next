...
export const ANALYSIS_PROMPT_TEMPLATE = (profileJson: string): string => `
...
export const INSIGHTS_PROMPT_TEMPLATE = (profileJson: string): string => `
...
export const TRAJECTORY_PROMPT_TEMPLATE = (
 ...
 */
export const BRANCH_CONVERSATION_EXTRACT_INTENT_PROMPT = (
 ...
 */
export const BRANCH_CONVERSATION_PRESENT_PLAN_PROMPT = (
  planJson: string,
  scheduleWasInferred: boolean
): string => `
 ...
 */
export const BRANCH_PLANNER_BUILD_PLAN_PROMPT = (
  intentJson: string,
  scheduleJson: string,
  wakingMinutesPerDay: number = 960
): string => `
